...
p1 + 
  ...
  plot_annotation(
    ...
    subtitle = "<i style='color:#E23636'>At 10 m depth, the effects of surface heterogeneity<br>is reduced.</i>",
    theme = theme(
...
p2 <- ggplot() +
  ...
  annotate("text", x = 42, y = -50, label = str_wrap("3D volume for which simulated data was extracted", width = 30), size = 4) +
  annotate("segment", x = 26, xend = 26, y = -40, yend = -28, lty = 1, size = 0.25, arrow = arrow(length = unit(1.5, "mm"))) +

  annotate("text", x = -75, y = -50, label = str_wrap("2D detectors placed every 0.5 m depth", width = 20), size = 4) +
